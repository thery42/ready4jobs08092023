...
class BottomNavigationBarItemInfo {
  ...
  BottomNavigationBarItemInfo({required this.iconData, required this.routeName});
}

class BottomNavigationBarWidget extends StatelessWidget {
  final List<BottomNavigationBarItemInfo> navigationItems = [
    BottomNavigationBarItemInfo(iconData: Icons.home, routeName: '/homepage'),
