...
class ForumBottomNavigationBarItemInfo {
  final IconData iconData;
  final String routeName;

  ForumBottomNavigationBarItemInfo({required this.iconData, required this.routeName});
}

class BottomNavigationBarWidget extends StatelessWidget {
  final List<ForumBottomNavigationBarItemInfo> navigationItems = [
    ForumBottomNavigationBarItemInfo(iconData: Icons.home, routeName: '/homepage'),
    ForumBottomNavigationBarItemInfo(iconData: Icons.description, routeName: '/cv'),
    ForumBottomNavigationBarItemInfo(iconData: Icons.calendar_today, routeName: '/entretiens'),
    ForumBottomNavigationBarItemInfo(iconData: Icons.person, routeName: '/profil'),
    ForumBottomNavigationBarItemInfo(iconData: Icons.lightbulb, routeName: '/forum'),
  ];
