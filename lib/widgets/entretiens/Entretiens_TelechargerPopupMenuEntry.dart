...
class EntretiensTelechargerPopupMenuEntry extends PopupMenuEntry<int> {
  @override
  double get height => 0;
...
class _TelechargerPopupMenuEntryState extends State<EntretiensTelechargerPopupMenuEntry> {
